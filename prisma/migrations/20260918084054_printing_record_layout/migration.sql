...
INSERT INTO "new_PrintingRecord" ("batchClass", "colourMode", "copies", "course", "createdAt", "date", "documentName", "gsmId", "id", "lecturerId", "lotId", "notes", "operatorId", "pages", "paperCostPerSheet", "paperSizeId", "paperTypeId", "physicalSheets", "priceRuleId", "printingChargePerSheet", "printingCode", "printingMachine", "sides", "subject", "totalCost", "totalPaperCost", "totalPrintingCharge", "wastedSheets") SELECT "batchClass", "colourMode", "copies", "course", "createdAt", "date", "documentName", "gsmId", "id", "lecturerId", "lotId", "notes", "operatorId", "pages", "paperCostPerSheet", "paperSizeId", "paperTypeId", "physicalSheets", "priceRuleId", "printingChargePerSheet", "printingCode", "printingMachine", "sides", "subject", "totalCost", "totalPaperCost", "totalPrintingCharge", "wastedSheets" FROM "PrintingRecord";
